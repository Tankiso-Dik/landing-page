...
- #### Products
  ...
  Products represent items that can be listed or sold. Each product includes:

  - `slug` – unique URL identifier
  - `listingName` – name shown in listings
  - `summary` – short marketing summary
  - `heroImage` – primary image
  - `images` – optional gallery
  - `shortDescription` – brief body text
  - `features` – list of feature objects (`title` and `description`)
  - `tags` – keywords used to relate products
  - `destinations` – weighted call-to-action links
  - `featured` and `featuredOrder` – control homepage placement
